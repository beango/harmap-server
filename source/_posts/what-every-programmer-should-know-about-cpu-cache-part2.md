...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/120.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/120.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/214.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/214.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/38.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/38.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/46.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/46.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/56.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/56.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/65.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/65.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/74.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/74.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/82.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/82.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/92.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/92.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/103.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/103.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/1110.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/1110.png "每个程序员都应该了解的 CPU 高速缓存")
<center>图 3.10: 顺序读访问, NPAD=0</center>

[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/122.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/122.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/132.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/132.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU高速缓存](/post-images/2013-03/142.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/142.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/152.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/152.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/162.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/162.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/172.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/172.png "每个程序员都应该了解的 CPU 高速缓存")
<center>图3.16: L2d未命中率</center>

　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/182.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/182.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/192.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/192.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/202.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/202.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/215.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/215.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/222.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/222.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/232.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/232.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/latex-math-1.gif "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/latex-math-1.gif "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/241.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/241.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/251.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/251.png "每个程序员都应该了解的 CPU 高速缓存")
...
[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/261.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/261.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/271.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/271.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　当然还有更大的不同。可以看到，读操作的性能在整个工作集范围内一直稳定在16字节/周期左右，在2^20 处的下降同样是由于DTLB的耗尽引起。能够达到这么高的数字，不但表明处理器能够预取数据，并且按时完成传输，而且还意味着，预取的数据是被装入L1d的。
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/281.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/281.png "每个程序员都应该了解的 CPU 高速缓存")
<center>图3.27: Core 2运行双线程时的带宽表现</center>

　　在图3.27中，启动双线程，各自运行在Core
2的一个核心上。它们访问相同的内存，但不需要完美同步。从结果上看，读操作的性能与单线程并无区别，只是多了一些多线程情况下常见的抖动。
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/291.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/291.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/30.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/30.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/311.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/311.png "每个程序员都应该了解的 CPU 高速缓存")
...
-   之后英特尔的双核心处理器模型拥有共享的L2
    缓存。对四核处理器，则分对拥有独立的L2 缓存，且没有更高层级的缓存。
...
　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/321.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/321.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　FSB在性能中扮演了核心角色。缓存数据的存取速度受制于内存通道的速度。我们做一个测试，在两台机器上分别跑同一个程序，这两台机器除了内存模块的速度有所差异，其它完全相同。图3.32展示了Addnext0测试(将下一个元素的pad[0]加到当前元素的pad[0]上)在这两台机器上的结果(NPAD=7，64位机器)。两台机器都采用Core
2处理器，一台使用667MHz的DDR2内存，另一台使用800MHz的DDR2内存(比前一台增长20%)。

　　[![每个程序员都应该了解的 CPU 高速缓存](/post-images/2013-03/331.png "每个程序员都应该了解的 CPU 高速缓存")](/post-images/2013-03/331.png "每个程序员都应该了解的 CPU 高速缓存")
...
　　如今，一些英特尔的处理器，支持前端总线(FSB)的速度高达1,333MHz，这意味着速度有另外60％的提升。将来还会出现更高的速度。速度是很重要的，工作集会更大，快速的RAM和高FSB速度的内存肯定是值得投资的。我们必须小心使用它，因为即使处理器可以支持更高的前端总线速度，但是主板的北桥芯片可能不会。使用时，检查它的规范是至关重要的。
